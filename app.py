...
def get_color_style(pct, is_tap=False):
    # --- TAMBAHKAN HOT-FIX INI DI BAGIAN ATAS FUNGSI ---
    try:
        pct = float(pct)  # Memaksa data menjadi angka float jika memungkinkan
    except (ValueError, TypeError):
        return 'background-color: #f1f3f5; color: #adb5bd; text-align: center;' # Jika teks, anggap sebagai kosong/NA
    # --------------------------------------------------
